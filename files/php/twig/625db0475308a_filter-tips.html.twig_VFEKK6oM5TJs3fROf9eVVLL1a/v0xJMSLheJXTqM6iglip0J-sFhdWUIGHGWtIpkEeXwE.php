...
class __TwigTemplate_0c5cf59053da9a78ba2418d1af6ebfb35ed861a92c84237c08f043125d9ab14b extends \Twig\Template
{
    private $source;
    private $macros = [];
...
($context["long"] ?? null)) ? (("filter-" . twig_replace_filter($this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, $context["item"], "id", [], "any", false, false, true, 45), 45, $this->source), ["/" => "-"]))) : (""))];
  ...
  ";
    ...
    {
        return new Source("", "core/themes/seven/templates/classy/content-edit/filter-tips.html.twig", "/var/sites/www/web/core/themes/seven/templates/classy/content-edit/filter-tips.html.twig");
    }
