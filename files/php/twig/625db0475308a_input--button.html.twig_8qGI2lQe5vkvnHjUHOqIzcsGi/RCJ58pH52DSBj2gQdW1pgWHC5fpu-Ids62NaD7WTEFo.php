...
class __TwigTemplate_59ce96b42960f4678e4a583237fb3f20b3f185543a9f48737a5bad9434fc3d0d extends \Twig\Template
{
    private $source;
    private $macros = [];
...
($context["icon"] ?? null) && ($context["icon_position"] ?? null)) &&  !($context["icon_only"] ?? null))) ? (("icon-" . $this->sandbox->ensureToStringAllowed(($context["icon_position"] ?? null), 30, $this->source))) : (""))];
  ...
  ";
    ...
    {
        return new Source("", "themes/contrib/bootstrap/templates/input/input--button.html.twig", "/var/sites/www/web/themes/contrib/bootstrap/templates/input/input--button.html.twig");
    }
